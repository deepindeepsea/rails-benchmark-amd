...
echo "=== Setup Complete! ==="
echo ""
echo "Ruby version: $(ruby -v || echo 'Ruby not found in current shell - please run: source ~/.bashrc')"
...
echo ""
echo "Important: Please restart your shell or run 'source ~/.bashrc' to use Ruby/Rails"